...
export default function ProdutoClient({ produto }) {
    ...
    return (
        <section className="h-full  bg-gray-400 flex flex-col gap-23">
            <section className="grid grid-cols-2 gap-2 dark:bg-red-500 px-73 ">
                <section className="flex flex-col items-end bg-green-100 h-fit gap-4">
                    ...
                    <div>
                        <p className="text-black">
                            Sou uma descrição do produto. Este é um ótimo lugar
                            para vender seu produto e chamar a atenção dos
                            visitantes. Descreva seu produto de forma clara e
                            concisa, use palavras-chave exclusivas e mostre seu
                            diferencial.
                        </p>
                    </div>
                </section>
